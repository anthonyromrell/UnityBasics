...
//Name: Booth2023d.ma
//Last modified: Sun, Oct 08, 2023 09:19:23 PM
//Codeset: UTF-8
requires maya "2023";
...
fileInfo "UUID" "76DBAC5D-7A40-4356-F1AD-04A2D2010FDC";
createNode transform -s -n "persp";
	rename -uid "940EF624-4B4B-8030-DB0F-1BBD52EC147F";
	setAttr ".v" no;
	setAttr ".t" -type "double3" 16.681616350000478 11.680515287825477 -7.0809261147509783 ;
	setAttr ".r" -type "double3" -25.538352734461562 832.99999999693705 0 ;
createNode camera -s -n "perspShape" -p "persp";
	rename -uid "C18C7531-CE4C-5C86-C2AB-EDB3156F2343";
	setAttr -k off ".v" no;
	setAttr ".fl" 34.999999999999986;
	setAttr ".coi" 20.084571881358915;
...
createNode transform -n "pPlane41" -p "group5";
	...
	setAttr ".t" -type "double3" 3 3.6000003814697266 -12 ;
	setAttr ".r" -type "double3" 90 0 0 ;
	setAttr ".rp" -type "double3" 0 5.5511151231257866e-16 -2.5000000000000018 ;
	setAttr ".rpt" -type "double3" 0 2.4999999999999996 2.5000000000000013 ;
	setAttr ".sp" -type "double3" 0 5.5511151231257866e-16 -2.5000000000000018 ;
...
createNode transform -n "pPlane44" -p "group5";
	...
	setAttr ".t" -type "double3" 7 3.5 -12 ;
	setAttr ".r" -type "double3" 89.999999999999901 179.99999999999972 0 ;
	setAttr ".rp" -type "double3" -1 0 2.4999999999999982 ;
	setAttr ".rpt" -type "double3" 0 -2.5 -2.4999999999999982 ;
	setAttr ".sp" -type "double3" -1 0 2.4999999999999982 ;
...
createNode transform -n "pCube4" -p "group8";
	...
	setAttr ".t" -type "double3" 8.6499996185302734 1.0000001539190917 -14.800169931651579 ;
...
createNode transform -n "pCube1" -p "group8";
	...
	setAttr ".t" -type "double3" 1.0272415528800178 0.99999978032853765 -9.8701519174032555 ;
...
createNode transform -n "pCylinder1" -p "group8";
	...
	setAttr ".t" -type "double3" -4.4147485819877401 1.0000001115949662 -6.5664437774788222 ;
...
createNode transform -n "pCube18" -p "group8";
	...
	setAttr ".t" -type "double3" 1 0.99999978032853765 -6.0121245489182336 ;
...
createNode transform -n "pCube19" -p "group8";
	...
	setAttr ".t" -type "double3" 6.919455274661332 0.99999978032853765 -1.5858015619353489 ;
	setAttr ".r" -type "double3" 0 -89.999999999999943 0 ;
	setAttr ".rp" -type "double3" -1 -0.99999978032853765 2 ;
	setAttr ".sp" -type "double3" -1 -0.99999978032853765 2 ;
...
createNode transform -n "pCube20" -p "group8";
	...
	setAttr ".t" -type "double3" 8.6499996185302717 1.0000001539190917 -7.5949259965424121 ;
	setAttr ".r" -type "double3" 0 -270.00000000000023 0 ;
	setAttr ".rp" -type "double3" 1.25 -1.0000000349858693 3 ;
	setAttr ".sp" -type "double3" 1.25 -1.0000000349858693 3 ;
...
createNode transform -n "pPlane46";
	...
	setAttr ".t" -type "double3" 3.9349913599350286 2.1786362681120166 3.7293435812208999 ;
...
createNode transform -n "pPlane47";
	...
	setAttr ".t" -type "double3" 1.9858367619692041 2.1786362681120166 3.7293435812208999 ;
	setAttr ".s" -type "double3" 0.86255766991113447 0.86255766991113447 0.86255766991113447 ;
...
createNode transform -n "pPlane48";
	...
	setAttr ".t" -type "double3" -3.8702849313171219 2.1786362681120166 3.7293435812208999 ;
	setAttr ".s" -type "double3" 0.86255766991113447 0.86255766991113447 0.86255766991113447 ;
...
createNode transform -n "pPlane49";
	...
	setAttr ".t" -type "double3" -1.9211303333512975 2.1786362681120166 3.7293435812208999 ;
	setAttr ".s" -type "double3" 0.86255766991113447 0.86255766991113447 0.86255766991113447 ;
...
createNode transform -n "pPlane50";
	rename -uid "2DCAA22A-4D4F-4A55-B568-CD9A0C5991A3";
	setAttr ".t" -type "double3" 3.8678426902546947 2.1786362681120166 -4.4877084334286153 ;
	setAttr ".r" -type "double3" 40 0 0 ;
	setAttr ".s" -type "double3" 0.86255766991113447 0.86255766991113447 0.86255766991113447 ;
	setAttr ".rp" -type "double3" 0 0 0.73317405963649418 ;
	setAttr ".sp" -type "double3" 0 0 0.85000004661953021 ;
	setAttr ".spt" -type "double3" 0 0 -0.11682598698305073 ;
createNode mesh -n "pPlaneShape50" -p "pPlane50";
	rename -uid "1DFF7344-054F-7F14-21A7-2B8905ADFB4C";
	setAttr -k off ".v";
	setAttr ".vir" yes;
	setAttr ".vif" yes;
	setAttr ".uvst[0].uvsn" -type "string" "map1";
...
createNode transform -n "pPlane51";
	rename -uid "11E79196-FD42-E189-5476-76B6CACA6B90";
	setAttr ".t" -type "double3" 1.9186880922888703 2.1786362681120166 -4.4877084334286153 ;
	setAttr ".r" -type "double3" 40 0 0 ;
	setAttr ".s" -type "double3" 0.86255766991113447 0.86255766991113447 0.86255766991113447 ;
	setAttr ".rp" -type "double3" 0 0 0.73317405963649418 ;
	setAttr ".sp" -type "double3" 0 0 0.85000004661953021 ;
...
createNode mesh -n "pPlaneShape51" -p "pPlane51";
	rename -uid "0D36B6B6-594D-6636-3AB9-72B2B616A7AA";
	setAttr -k off ".v";
	setAttr ".vir" yes;
	setAttr ".vif" yes;
	setAttr ".uvst[0].uvsn" -type "string" "map1";
...
createNode transform -n "pPlane52";
	rename -uid "818836B1-CB4D-F6EC-ACF2-9DA1A5A11A03";
	setAttr ".t" -type "double3" -0.031935216738300021 2.1786362681120166 -4.4877084334286153 ;
	setAttr ".r" -type "double3" 40 0 0 ;
	setAttr ".s" -type "double3" 0.86255766991113447 0.86255766991113447 0.86255766991113447 ;
	setAttr ".rp" -type "double3" 0 0 0.73317405963649418 ;
	setAttr ".sp" -type "double3" 0 0 0.85000004661953021 ;
...
createNode mesh -n "pPlaneShape52" -p "pPlane52";
	rename -uid "3DA69063-EE48-C98D-3CB7-40A63E6948FD";
	setAttr -k off ".v";
	setAttr ".vir" yes;
	setAttr ".vif" yes;
	setAttr ".uvst[0].uvsn" -type "string" "map1";
...
createNode transform -n "pPlane53";
	...
	setAttr ".t" -type "double3" -0.031935216738300021 2.1786362681120166 -2.9211244519256518 ;
	setAttr ".s" -type "double3" 0.86255766991113447 0.86255766991113447 0.86255766991113447 ;
...
createNode transform -n "pPlane54";
	...
	setAttr ".t" -type "double3" 1.9186880922888703 2.1786362681120166 -2.9211244519256518 ;
	setAttr ".s" -type "double3" 0.86255766991113447 0.86255766991113447 0.86255766991113447 ;
...
createNode transform -n "pPlane55";
	...
	setAttr ".t" -type "double3" 3.8678426902546947 2.1786362681120166 -2.9211244519256518 ;
	setAttr ".s" -type "double3" 0.86255766991113447 0.86255766991113447 0.86255766991113447 ;
...
connectAttr "pPlaneShape50.iog" ":initialShadingGroup.dsm" -na;
connectAttr "pPlaneShape51.iog" ":initialShadingGroup.dsm" -na;
connectAttr "pPlaneShape52.iog" ":initialShadingGroup.dsm" -na;
